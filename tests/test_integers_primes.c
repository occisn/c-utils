...
void test_nth_prime_uint64(void)
{
    ...
    TEST_ASSERT_EQUAL_UINT64_MESSAGE(2, nth_prime_uint64(1), 
                                     "1st prime should be 2");
    
    // Test first few primes
    TEST_ASSERT_EQUAL_UINT64_MESSAGE(3, nth_prime_uint64(2), 
                                     "2nd prime should be 3");
    TEST_ASSERT_EQUAL_UINT64_MESSAGE(5, nth_prime_uint64(3), 
                                     "3rd prime should be 5");
    TEST_ASSERT_EQUAL_UINT64_MESSAGE(7, nth_prime_uint64(4), 
                                     "4th prime should be 7");
    TEST_ASSERT_EQUAL_UINT64_MESSAGE(11, nth_prime_uint64(5), 
                                     "5th prime should be 11");
    TEST_ASSERT_EQUAL_UINT64_MESSAGE(13, nth_prime_uint64(6), 
                                     "6th prime should be 13");
    
    // Test additional cases
    TEST_ASSERT_EQUAL_UINT64_MESSAGE(29, nth_prime_uint64(10), 
                                     "10th prime should be 29");
    TEST_ASSERT_EQUAL_UINT64_MESSAGE(97, nth_prime_uint64(25), 
                                     "25th prime should be 97");
    TEST_ASSERT_EQUAL_UINT64_MESSAGE(541, nth_prime_uint64(100), 
                                     "100th prime should be 541");
    TEST_ASSERT_EQUAL_UINT64_MESSAGE(1223, nth_prime_uint64(200), 
                                     "200th prime should be 1223");
    TEST_ASSERT_EQUAL_UINT64_MESSAGE(7919, nth_prime_uint64(1000), 
